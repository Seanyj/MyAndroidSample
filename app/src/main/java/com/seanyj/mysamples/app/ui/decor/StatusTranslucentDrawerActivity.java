...
public class StatusTranslucentDrawerActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_status_translucent_drawer);
        setStatusBarFullTransparent();
        NavigationView navigationView = findViewById(R.id.nav_view);
        navigationView.getHeaderView(0).setPadding(0, SystemUiUtil.getStatusBarHeight(this), 0, 0);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.status_translucent_drawer, menu);
        return true;
    }
