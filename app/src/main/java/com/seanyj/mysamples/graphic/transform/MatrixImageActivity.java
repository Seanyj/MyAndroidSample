...
public class MatrixImageActivity extends AppCompatActivity {
    ...
    public static class MatrixImageView extends androidx.appcompat.widget.AppCompatImageView {
         ...
         * 设置图片资源
         */
            Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.sceney16);
            bitmap = Bitmap.createScaledBitmap(bitmap, DensityUtil.getScreenSize(mContext).x,
                    DensityUtil.getScreenSize(mContext).y, true);
